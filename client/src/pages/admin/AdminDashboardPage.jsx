        ...
        <div className="min-w-0">
            ...
            <div className="flex h-16 items-center gap-4">
              ...
              <div className="ml-auto flex min-w-0 items-center gap-3">
                ...
                <div className="hidden min-w-0 sm:block">
                  <p className="max-w-48 truncate text-sm font-semibold text-slate-900 dark:text-slate-100">{user?.name || 'Administrator'}</p>
          ...
          <div className="mx-auto max-w-[82rem] px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
            <header className="mb-6">
              <p className="text-xs font-semibold uppercase tracking-[0.14em] text-teal-700 dark:text-teal-300">Platform operations</p>
