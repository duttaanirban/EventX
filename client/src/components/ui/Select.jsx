    ...
    <label className="block">
      ...
      <select
        className={clsx(
          ...
          isDark
            ? 'border-slate-200 dark:border-white/10 bg-white dark:bg-[#151e29] text-slate-900 dark:text-white hover:border-slate-200 dark:hover:border-white/20 focus:border-teal-400/60'
      ...
      {error ? <span className="mt-1.5 block text-xs font-medium text-rose-700 dark:text-rose-400">{error}</span> : null}
    </label>
  );
}
