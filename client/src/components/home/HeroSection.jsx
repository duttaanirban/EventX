...
export function HeroSection() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-slate-50 dark:bg-[#060a10] text-slate-900 dark:text-white">
      ...
      <div className="relative mx-auto grid min-h-[calc(100dvh-4.5rem-1px)] max-w-7xl items-center gap-8 px-4 py-10 sm:px-6 sm:py-12 lg:grid-cols-2 lg:gap-6 lg:px-8 lg:py-12">
        <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
          <span className="inline-flex items-center gap-2 rounded-full border border-teal-400/20 bg-teal-400/10 px-3 py-1.5 text-sm font-semibold text-teal-700 dark:text-teal-200">
            <Lightning weight="regular" aria-hidden="true" className="h-4 w-4" />
            Smarter Event Experiences
          </span>
          <h1 className="mt-6 max-w-3xl text-4xl font-black leading-[1.08] tracking-normal text-slate-900 dark:text-white sm:text-5xl lg:text-6xl xl:text-7xl">
            Bring People Together with{' '}
            <span className="bg-gradient-to-r from-teal-700 via-teal-600 to-cyan-700 dark:from-teal-200 dark:via-teal-300 dark:to-cyan-300 bg-clip-text text-transparent drop-shadow-[0_0_18px_rgba(45,212,191,0.18)]">EventX</span>
          </h1>
        ...
        >
          <div className="overflow-hidden rounded-2xl border border-slate-200 dark:border-white/10 bg-slate-900/5 dark:bg-white/[0.04] p-2 shadow-[0_30px_90px_rgba(0,0,0,0.45)]">
